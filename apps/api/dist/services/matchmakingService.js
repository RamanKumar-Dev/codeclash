...
class MatchmakingService {
    constructor(redis, prisma, io) {
        ...
        this.queueWaitTime = new Map(); // Track wait times for expanding ELO window
        this.QUEUE_KEY = 'matchmaking:queue';
        this.INITIAL_ELO_WINDOW = 200;
        this.ELO_WINDOW_EXPANSION = 50;
        this.EXPANSION_INTERVAL = 10000; // 10 seconds
    ...
    findMatches(queuedPlayers, playerWindows) {
        const matches = [];
    ...
    async initializeBattleState(roomId, player1Id, player2Id) {
